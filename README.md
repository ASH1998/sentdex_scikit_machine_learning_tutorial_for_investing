...
> This is the same code as in the videos, however a github repo makes it easy to grab the code using ```git clone https://github.com/cleesmith/sentdex_scikit_machine_learning_tutorial_for_investing.git```.
